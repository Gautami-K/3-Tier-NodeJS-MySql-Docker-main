    ...
    stages {
        ...
        stage('Docker build') {
         ...
         stage('Deploy SVC-APP') {
            steps {
                script {
                     withKubeConfig(caCertificate: '', clusterName: ' devopsshack-cluster', contextName: '', credentialsId: 'K8-Creds', namespace: 'webapps', restrictKubeConfigAccess: false, serverUrl: 'https://6E4BF3D58DD532BF513F2BD0159EC685.gr7.us-east-1.eks.amazonaws.com') {
