pipeline {
    ...
    stages {
        stage('Git Checkout') {
            steps {
                git branch: 'master', url: 'https://github.com/Gautami-K/3-Tier-NodeJS-MySql-Docker-main.git'
            }
        }
        ...
        stage('Docker build') {
         ...
         stage('Deploy SVC-APP') {
            steps {
                script {
                    withKubeConfig(caCertificate: '', clusterName: 'devopsshack-cluster', contextName: '', credentialsId: 'K8-Creds', namespace: 'webapps', restrictKubeConfigAccess: false, serverUrl: 'https://46743932FDE6B34C74566F392E30CABA.gr7.ap-south-1.eks.amazonaws.com') {
